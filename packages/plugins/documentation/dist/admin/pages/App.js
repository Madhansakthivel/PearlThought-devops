...
const App = ()=>{
    ...
    const { data, isLoading: isLoadingInfo, isError } = api.useGetInfoQuery();
    const [regenerate] = api.useRegenerateDocMutation();
    const [deleteVersion] = api.useDeleteVersionMutation();
    ...
    const { allowedActions, isLoading: isLoadingRBAC } = admin.useRBAC(constants.PERMISSIONS);
