...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-FOR3ZZWG.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-VJIWFSKY.js").then((mod) => ({
          default: mod.App
        })),
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-LMLUROUC.js");
...
//# sourceMappingURL=chunk-GN4EMOVM.js.map
